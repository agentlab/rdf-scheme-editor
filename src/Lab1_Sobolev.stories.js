...
const styles = StyleSheet.create({
      ...
      shadowtext: {
          textShadow: '10px 10px 20px black'/* Параметры тени */
      ...
      sel:{backgroundColor:'linear-gradient(180deg, rgba(177,208,250,1) 0%, rgba(248,248,251,1) 100%)', 
...
for (var requirement in requirements) {
  ...
  if(requirements[requirement]=='disconnect')
    container.push(<div> <Icon  type={requirements[requirement]} className={css(styles.orange)}/>  {requirement}</div>);
  else if (requirements[requirement]=='interation') 
  container.push(<div> <Icon  type={requirements[requirement]} theme='filled' className={css(styles.blue)}/>  {requirement}</div>);
        
  else container.push(<div> <Icon  type={requirements[requirement]}  className={css(styles.blue)}/>  {requirement}</div>);
}
                        ...
                        <Layout className={css(styles.formcolor)}>     
                            ...
                            <Content classname={css(styles.content3)}>
                                ...
                                <Form.Item className={css(styles.size16)}> 
                                    ...
                                    <div className={css(styles.scroll_container)}>{container}
                                    </div>
                            ...
                            <Content >    
                                <Form.Item> 
                                    ...
                                    <div className={css(styles.column)} >
                                        ...
                                        <Button  className={css(styles.size16)}> Изменить</Button></div>
                                      

                                    <br/><br/><br/><br/>            
                                
                                      
                                    <div className={css(styles.center)}><a className={css(styles.size16)}>Вернуть значение по умолчанию</a></div>
                            ...
                            <Content className={css(styles.content2)}>
                                ...
                                <Form.Item className={css(styles.size16)}> 
                                    ...
                                    <div className={css(styles.border2)}>
                                        <Row>
                                            <Col span={10}>ИД</Col>
                                            <Col span={8}><InputNumber className={css(styles.size16)} min={0} defaultValue={45} /></Col>
                                            <Col span={6}>&nbsp;</Col>
                                        </Row>
                                        ...
                                        <Row>
                                            <Col span={10}>Имя</Col>
                                            <Col span={8}><InputNumber className={css(styles.size16)} min={0} defaultValue={222} /></Col>
                                            <Col span={6}>&nbsp;</Col>
                                        </Row>


                                        <Row>
                                            <Col span={10} className={css(styles.shadowtext)}>Тип требования</Col>
                                            <Col span={8}><InputNumber className={css(styles.size16)} min={0} defaultValue={222} /></Col>
                                            <Col span={6}>&nbsp;</Col>                                              
                                          </Row>
                                        ...
                                        <Row>
                                            ...
                                            <Col span={8}><InputNumber className={css(styles.size16)}  min={0} defaultValue={174} /></Col>
                                            <Col span={6}>&nbsp;</Col>                                              
                                        </Row>
                                        ...
                                        <Row>
                                            ...
                                            <Col span={8}><InputNumber className={css(styles.size16)} min={0} defaultValue={185} /></Col>
                                            <Col span={6}>&nbsp;</Col>
                            ...
                            <Row >
                                ...
                                <Col span={3}>
                                    ...
                                    <Form.Item > 
                                        ...
                                        <Button className={css(styles.size16)}>
                                            ОК</Button>
